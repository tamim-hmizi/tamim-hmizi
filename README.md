...
![Route53](https://img.shields.io/badge/Route53-FF9900?style=flat-square&logo=amazon-route53&logoColor=white)
...
![Cloud Run](https://img.shields.io/badge/Cloud_Run-4285F4?style=flat-square&logo=google-cloud-run&logoColor=white)
...
- Lead automation, cloud migration, and DevOps projects
...
- Implemented AI-driven recommendation engine for Kubernetes vs. VM deployments
- Automated infrastructure workflows with Jenkins, Terraform, Ansible, Docker
...
- Automated CI/CD pipelines with Jenkins, Terraform, Docker, GitHub Actions
...
- Built Python web scraping system with BeautifulSoup and Scrapy
...
- **Focus:** Cloud Computing, DevOps, Full-Stack Development
- **Final Project:** Production-grade DevOps-as-a-Service platform with AI-powered recommendations
